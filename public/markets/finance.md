...
`Datatype`: `FLOAT`
`Description`: `Dow Jones index value`

### financial_date_snp500
`Datatype`: `FLOAT`
`Description`: `SNP500 index value`

### financial_date_nasdaq
`Datatype`: `FLOAT`
`Description`: `NASDAQ index value`

### financial_date_stoxx
`Datatype`: `FLOAT`
`Description`: `STOXX index value`

### financial_date_vix
`Datatype`: `FLOAT`
`Description`: `VIX index value`

### financial_date_crude_oil_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `Crude oil price trend 1d/7d`

### financial_date_usd_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `USD trend 1d/7d`

### financial_date_usd_eur_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `USD/EUR price trend 1d/7d`

### financial_date_gold_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `Gold price trend 1d/7d`

### financial_date_natural_gas_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `Natural gas price trend 1d/7d`

### financial_date_silver_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `Silver price trend 1d/7d`

### financial_date_dow_jones_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `Dow Jones index value trend 1d/7d`

### financial_date_snp500_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `SNP500 index value trend 1d/7d`

### financial_date_nasdaq_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `NASDAQ index value trend 1d/7d`

### financial_date_stoxx_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `STOXX index value trend 1d/7d`

### financial_date_vix_1d_to_7d
`Datatype`: `FLOAT`
`Description`: `VIX index value trend 1d/7d`

### financial_date_crude_oil_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `Crude oil price trend 7d/1y`

### financial_date_usd_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `USD trend 7d/1y`

### financial_date_usd_eur_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `USD/EUR price trend 7d/1y`

### financial_date_gold_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `Gold price trend 7d/1y`

### financial_date_natural_gas_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `Natural gas price trend 7d/1y`

### financial_date_silver_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `Silver price trend 7d/1y`

### financial_date_dow_jones_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `Dow Jones index value trend 7d/1y`

### financial_date_snp500_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `SNP500 index value trend 7d/1y`

### financial_date_nasdaq_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `NASDAQ index value trend 7d/1y`

### financial_date_stoxx_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `STOXX index value trend 7d/1y`

### financial_date_vix_7d_to_1y
`Datatype`: `FLOAT`
`Description`: `VIX index value trend 7d/1y`

### financial_date_crude_oil_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `Crude oil price trend 7d/7d1y`

### financial_date_usd_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `USD trend 7d/7d1y`

### financial_date_usd_eur_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `USD/EUR trend 7d/7d1y`

### financial_date_gold_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `Gold price trend 7d/7d1y`

### financial_date_natural_gas_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `Natural gas price trend 7d/7d1y`

### financial_date_silver_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `Silver price trend 7d/7d1y`

### financial_date_dow_jones_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `Dow Jones index value trend 7d/7d1y`

### financial_date_snp500_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `SNP500 index value trend 7d/7d1y`

### financial_date_nasdaq_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `NASDAQ index value trend 7d/7d1y`

### financial_date_stoxx_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `STOXX index value trend 7d/7d1y`

### financial_date_vix_7d_to_7d_1y_shift
`Datatype`: `FLOAT`
`Description`: `VIX index value trend 7d/7d1y`

### financial_date_crude_oil_gap
`Datatype`: `FLOAT`
`Description`: `Crude oil gap`
...
`Datatype`: `FLOAT`
`Description`: `ESD/EUR gap`

### financial_date_gold_gap
`Datatype`: `FLOAT`
`Description`: `Gold gap`

### financial_date_natural_gas_gap
`Datatype`: `FLOAT`
`Description`: `Natural gas gap`

### financial_date_silver_gap
`Datatype`: `FLOAT`
`Description`: `Silver gap`

### financial_date_dow_jones_gap
`Datatype`: `FLOAT`
`Description`: `Dow Jones index value gap`

### financial_date_snp500_gap
`Datatype`: `FLOAT`
`Description`: `SNP500  index value gap`

### financial_date_nasdaq_gap
`Datatype`: `FLOAT`
`Description`: `NASDAQ  index value gap`

### financial_date_stoxx_gap
`Datatype`: `FLOAT`
`Description`: `STOXX  index value gap`

### financial_date_vix_gap
`Datatype`: `FLOAT`
`Description`: `VIX  index value gap`

### financial_date_crude_oil_daydiff
`Datatype`: `FLOAT`
`Description`: `Crude oil price day difference`

### financial_date_usd_daydiff
`Datatype`: `FLOAT`
`Description`: `USD day difference`

### financial_date_usd_eur_daydiff
`Datatype`: `FLOAT`
`Description`: `USD/EUR  day difference`

### financial_date_gold_daydiff
`Datatype`: `FLOAT`
`Description`: `Gold price day difference`

### financial_date_natural_gas_daydiff
`Datatype`: `FLOAT`
`Description`: `Natural gas price  day difference`

### financial_date_silver_daydiff
`Datatype`: `FLOAT`
`Description`: `Silver price  day difference`

### financial_date_dow_jones_daydiff
`Datatype`: `FLOAT`
`Description`: `Dow Jones index value day difference`

### financial_date_snp500_daydiff
`Datatype`: `FLOAT`
`Description`: `SNP500 index value day difference`

### financial_date_nasdaq_daydiff
`Datatype`: `FLOAT`
`Description`: `NASDAQ index value day difference`

### financial_date_stoxx_daydiff
`Datatype`: `FLOAT`
`Description`: `STOXX index value day difference`
